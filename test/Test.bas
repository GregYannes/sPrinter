...
Public Sub Test_Message()
	...
	Dim arrMsg0 As String: arrMsg0 = sPrinter.xMessage(fmt0, arrData,          , default := DEFAULT_VALUE)
	Dim arrMsg2 As String: arrMsg2 = sPrinter.xMessage(fmt2, arrData,          , default := DEFAULT_VALUE, position := posRelative)
	Dim arrMsg3 As String: arrMsg3 = sPrinter.xMessage(fmt3, arrData,          , default := DEFAULT_VALUE)
	Dim arrMsg4 As String: arrMsg4 = sPrinter.xMessage(fmt4, arrData, arrLookup, default := DEFAULT_VALUE)
	Dim arrMsg5 As String: arrMsg5 = sPrinter.xMessage(fmt5, arrData, arrLookup, default := DEFAULT_VALUE, position := posRelative)
	
	
	Dim clxMsg1 As String: clxMsg1 = sPrinter.xMessage(fmt1, clxData,          , default := DEFAULT_VALUE)
	Dim clxMsg2 As String: clxMsg2 = sPrinter.xMessage(fmt2, clxData,          , default := DEFAULT_VALUE, position := posRelative)
	Dim clxMsg3 As String: clxMsg3 = sPrinter.xMessage(fmt3, clxData,          , default := DEFAULT_VALUE)
	Dim clxMsg4 As String: clxMsg4 = sPrinter.xMessage(fmt4, clxData,          , default := DEFAULT_VALUE)
	Dim clxMsg5 As String: clxMsg5 = sPrinter.xMessage(fmt5, clxData, arrLookup, default := DEFAULT_VALUE, position := posRelative)
